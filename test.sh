...
# curl -X POST http://localhost:3001/api/chat -H "Content-Type: application/json" -d '{"question": "plan a trip to Da Nang?", "thread_id": "808xa"}'
# curl -X POST http://localhost:3001/api/chat -H "Content-Type: application/json" -d '{"question": "for 2 days", "thread_id": "808xa"}'

curl -X POST http://localhost:3001/api/chat -H "Content-Type: application/json" -d '{"question": "Show me flight to da nang", "thread_id": "mzz"}'
curl -X POST http://localhost:3001/api/chat -H "Content-Type: application/json" -d '{"question": "ho chi minh", "thread_id": "mzz"}'
