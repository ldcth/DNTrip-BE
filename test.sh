...
curl -X POST http://localhost:3001/api/travel -H "Content-Type: application/json" -d '{"question": "My name is John Doe"}'

curl -X POST http://localhost:3001/api/travel -H "Content-Type: application/json" -d '{"question": "What is my name?", "thread_id": "123"}'
